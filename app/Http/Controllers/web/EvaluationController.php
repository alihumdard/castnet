...
class EvaluationController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('web.pages.evaluation', $data);
    }
    public function rulesOfEngagement(Request $request)
    {
        $data['largelogo']   = $this->largelogo(); 
        $data['smalllogo']   = $this->smalllogo(); 
        $data['mediumlogo']   = $this->mediumlogo(); 
        $data['socialmedia']   = $this->socialmedia(); 
        return view('web.pages.rules_of_engagement', $data);
    }
    public function sectors(Request $request)
    {
        ...
        $data['mediumlogo']   = $this->mediumlogo(); 
        $data['socialmedia']   = $this->socialmedia(); 
        return view('web.pages.sectors', $data);
    }
