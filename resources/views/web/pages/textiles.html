...
<body>
    ...
    <!-- Breadcrumb Start -->
    <section class="section_breadcrumb sectors_textiles_bg">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb_title">textiles</h2>
            ...
            <div class="row gy-5 gy-md-0 gx-md-5">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    <div class="img_border">
                        <img src="assets/web/images/intro_textiles.png" alt="textiles">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row gy-5 gy-lg-0">
                <div class="col-lg-5" data-aos="fade-right" data-aos-duration="1000">
                    <div class="card">
                        <img src="assets/web/images/main_featured_image6.png" alt="main" class="card-img-top">
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-duration="1000">
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image16.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                    ...
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image17.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                                <a href="#">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a>
                    ...
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image18.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                                <a href="#">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a>
