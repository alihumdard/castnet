    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="breadcrumb_title">Term of Use</h2>
...
<section class="section_block welcome pb-0 pt-5">
    <div class="container">
        <div class="row gy-5 gy-md-0 gx-md-5">
            <div class="col-lg-12 mb-5" data-aos="fade-right" data-aos-duration="1000">
                {!! $section1->text !!}
            </div>
    ...
    <section class="section_block welcome pb-0">
        <div class="container">
            <div class="row gy-5 gy-md-0 gx-md-5">
                <div class="col-lg-12 text-span" data-aos="fade-right" data-aos-duration="1000">
                    {!! $section2->text !!}
                </div>
            </div>
        </div>
