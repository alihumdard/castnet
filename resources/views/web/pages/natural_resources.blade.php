...
<head>
    ...
    <title>Natural Resources | Castnet</title>
...
<body>
    ...
    <!-- Breadcrumb Start -->
    <section class="section_breadcrumb sectors_naturalresources_bg">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb_title">natural resources</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="index.html">home</a></li>
                            <li class="breadcrumb-item"><a href="sectors.html">sectors</a></li>
                            <li class="breadcrumb-item active" aria-current="page">natural resources</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row gy-5 gy-md-0 gx-md-5">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    <div class="img_border">
                        <img src="assets/web/images/intro_nr.png" alt="natural resources">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row gy-5 gy-lg-0">
                <div class="col-lg-5" data-aos="fade-right" data-aos-duration="1000">
                    <div class="card">
                        <img src="assets/web/images/main_featured_image4.png" alt="main" class="card-img-top">
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-duration="1000">
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image10.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                    ...
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image11.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                                <a href="#">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a>
                    ...
                    <div class="blog_item">
                        <div class="featured_image">
                            <img src="assets/web/images/featured_image12.png" alt="featured image">
                        </div>
                        <div class="content">
                            <h3 class="blog_title">
                                <a href="#">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a>
