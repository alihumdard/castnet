...
<head>
    ...
    <title>Opportunities &dash; RFX | Castnet</title>
...
<body>
    ...
    <!-- Breadcrumb Start -->
    <section class="section_breadcrumb rfx_bg">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb_title">RFX</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="index.html">home</a></li>
                            <li class="breadcrumb-item"><a href="opportunities.html">Opportunities</a></li>
                            <li class="breadcrumb-item active" aria-current="page">RFX</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row gx-md-5">
                <div class="col-lg-6 order-1 order-lg-1" data-aos="fade-right" data-aos-duration="1000">
                    <div class="img_border">
                        <img src="assets/web/images/rfx_intro.png" alt="rfx_intro">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row gx-md-5">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-duration="1000">
                    <div class="img_border">
                        <img src="assets/web/images/rfx_intro2.png" alt="rfx_intro">
                    </div>
                </div>
