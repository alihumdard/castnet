...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb_title">Zimbabwe</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="index.html">home</a></li>
                            <li class="breadcrumb-item"><a href="outreach.html">outreach</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Zimbabwe</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="section_map" data-aos="zoom-in" data-aos-duration="1000">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img src="assets/web/images/map_zim.png" alt="map" class="img-map">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gx-md-5">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-duration="1000">
                    <div class="img_border">
                        <img src="assets/web/images/culture_zim.png" alt="culture_zim">
                    </div>
                </div>
