                        ...
                        <div class="card-body">
                            <form action="{{ route('Jobs.update',$section->id)}}" id="section1" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <input type="checkbox" id="checkboxPrimary1" name="fulltime" {{ $decodedDetail[0] ? 'checked' : '' }}>
                                    <label for="checkboxPrimary1">
                                        Fulltime
                                    </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                    <input type="checkbox" id="checkboxPrimary2" name="engineering" {{ $decodedDetail[1] ? 'checked' : '' }}>
                                    <label for="checkboxPrimary2">
                                        Engineering
                                    </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                    <input type="checkbox" id="checkboxPrimary3" name="onsite" {{ $decodedDetail[2] ? 'checked' : '' }}>
