        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('programs.updation',$section1->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-2">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group errorshow">
                                            ...
                                            <textarea type="text" name="description" class="form-control" cols="30" rows="3">{{ $section1->description ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
