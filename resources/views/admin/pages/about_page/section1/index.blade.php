        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('aboutUs.section1Update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-2">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="previousImage" value="{{ $section1Record->image ?? '' }}" class="form-control" id="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <img src="{{ asset($section1Record->image ?? '') }}" alt="Image" width="50" height="50">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-12">
