        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('benefits.updation',$section->id) }}" id="benefits" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-2">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group errorshow">
                                            ...
                                            <textarea type="text" name="description" class="form-control" cols="30" rows="3">{{ $section->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('benefits.show',$section->id) }}" class="btn btn-sm btn-primary" style="float: right;">Add Features</a>
                        </div>
                        <div class="card-body">
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach($section->details as $key=>$item)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $item->title }}</td>
