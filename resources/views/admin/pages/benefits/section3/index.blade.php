    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Benefits Section 2</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body">
                                <form action="{{ route('benefitsSection2.udpate', ['id' => $section1Benefits->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('benefits-section3.create') }}" class="btn btn-sm btn-primary" style="float: right;">Add Features</a>
                        </div>
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! $item->description !!}</td>
                                                                  <td>
                                        <a href="{{ route('benefits-section3.edit',$item->id) }}"><i class="fa fa-edit"></i></a>

                                        <button class="btn-outline-danger delete_btn" data-url="/admin/benefits-section3"
